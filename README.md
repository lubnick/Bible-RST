# Bible-RST
Библия на русском языке в синодальном переводе для использования в [Obsidian](https://obsidian.md/).
...
## Навигация по Библии
Навигация организована по подобию таковой в приложении MyBible.
...
> таким образом нет зависимости от того, какой порядок сортировки используется в вашем хранилище: Библия будет всегда отображаться одинаково. 
